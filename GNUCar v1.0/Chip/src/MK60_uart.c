...
void uart_init (UARTn_e uratn, uint32 baud)
{
    ...
    case UART1:
        ...
        if(UART1_RX_PIN == PTC3)
        {
            port_init( PTC3, ALT3);             //在PTC3上使能UART1_RXD
        }
        else if(UART1_RX_PIN == PTE1)
        {
        ...
        if(UART1_TX_PIN == PTC4)
        {
            port_init( PTC4, ALT3);             //在PTC4上使能UART1_RXD
        }
        else if(UART1_TX_PIN == PTE0)
        {
    ...
    case UART4:
        ...
        if(UART4_RX_PIN == PTC14)
        {
            port_init( PTC14, ALT3);            //在PTC14上使能UART4_RXD
        }
        else if(UART4_RX_PIN == PTE25)
        {
        ...
        if(UART4_TX_PIN == PTC15)
        {
            port_init( PTC15, ALT3);            //在PTC15上使能UART4_RXD
        }
        else if(UART4_TX_PIN == PTE24)
        {
    ...
    case UART5:
        ...
        if(UART5_RX_PIN == PTD8)
        {
            port_init( PTD8, ALT3);             //在PTD8上使能UART5_RXD
        }
        else if(UART5_RX_PIN == PTE9)
        {
        ...
        if(UART5_TX_PIN == PTD9)
        {
            port_init( PTD9, ALT3);             //在PTD9上使能UART5_RXD
        }
        else if(UART5_TX_PIN == PTE8)
        {
